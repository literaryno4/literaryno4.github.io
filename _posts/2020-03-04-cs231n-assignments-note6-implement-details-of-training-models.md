---
layout: post
title:  "CS231n Assignments Note6: Implement Details of Training Models"
categories: jekyll update
---

Table of Contents:

- [A Class Model for Implementing Networks](#model)
- [A Solver Class as An API to Train Models](#solver)
